// ============================================================================
// oaip-legacy.typ — прежний СТП-стиль тела отчёта по ОАиП (БГУИР).
// Основной шаблон теперь oaip.typ (титульник тот же, тело — arXiv).
// Здесь всё как было: СТП 01–2024, Times New Roman 14 pt, прописные
// разделы с новой страницы. Вернуть: #import ".../oaip-legacy.typ": *
// и #show: oaip_legacy.with(...).
// ============================================================================
